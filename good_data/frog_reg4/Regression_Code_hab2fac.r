...
####load data############
frog_root<-"I:\\Dropbox\\Robin_data_test\\frog_reg4\\" #PC path
setwd(frog_root)
...
levels(mlrfrog$HabFac)[levels(mlrfrog$HabFac)!="Arboreal"] = "NonArboreal" #change nonarboreal to nonarboreal
