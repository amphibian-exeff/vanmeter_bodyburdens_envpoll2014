...
####load data############
frog_root<-"D:\\Dropbox\\Robin_data_test\\frog_reg7\\" #PC path
setwd(frog_root)
...
###Regression BCF################
#######################################
mlrfrog_BCF_test=subset(mlrfrog,select=c(logBCF,Species,HabFac,logKow,logkoc,Hlaw,VapPrs_mPa, logMol, logSol, logDen))
...
#######################################
mlrfrog_tc_test=subset(mlrfrog,select=c(logTissueConc,Species,HabFac,logKow,logkoc,Hlaw,VapPrs_mPa,app_rate_g_cm2,bodyweight2,SA_cm2_2, logMol, logSol, logDen))
...
#######################################
mlrfrog_af_test=subset(mlrfrog,select=c(logAppFactor,Species,HabFac,logKow,logkoc,Hlaw,VapPrs_mPa,logMol, logSol, logDen))
