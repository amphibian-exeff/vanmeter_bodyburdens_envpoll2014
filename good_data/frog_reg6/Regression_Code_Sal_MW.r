...
raw_data_t1 = raw_data[which(raw_data_t1$Application=="Soil"),] #select good data
...
###Regression BCF################
#######################################
mlrfrog_BCF_test=subset(mlrfrog,select=c(logBCF,Species,HabFac,logKow,logkoc,Hlaw,VapPrs_mPa, molmass_gmol, Solat20C_mgL, Density_gcm3))
...
#######################################
mlrfrog_tc_test=subset(mlrfrog,select=c(logTissueConc,Species,HabFac,logKow,logkoc,Hlaw,VapPrs_mPa,app_rate_g_cm2,bodyweight2,SA_cm2_2,molmass_gmol,Solat20C_mgL,Density_gcm3))
...
#######################################
mlrfrog_sc_test=subset(mlrfrog,select=c(logSoilConc,app_rate_g_cm2,logKow,logkoc,Hlaw,VapPrs_mPa,molmass_gmol,Solat20C_mgL,Density_gcm3))
...
#######################################
mlrfrog_af_test=subset(mlrfrog,select=c(logAppFactor,Species,HabFac,logKow,logkoc,Hlaw,VapPrs_mPa,molmass_gmol,Solat20C_mgL,Density_gcm3))
