...
mlrfrog = subset(raw_data_t2, select=c(Species, app_rate_g_cm2, AppFactor, TissueConc, SoilConc, logKow, BCF, VapPrs_mPa, Koc_Lit,
                                           HabFac, Hlaw, bodyweight2, SA_cm2_2)) 
mlrfrog$Koc_Lit=as.numeric(as.character(mlrfrog$Koc_Lit)) #convert factors to numerics
mlrfrog$Koc_Lit=log(mlrfrog$Koc_Lit)
...
#####Based on the correlation matrix, I can only keep a.logkoc, d.AppFactor
