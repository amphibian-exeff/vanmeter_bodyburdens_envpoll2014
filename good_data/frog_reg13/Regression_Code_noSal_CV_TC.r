...
write.table(Final_RMSE, file = "Final_RMSE_TC.xls", sep="\t", row.names = F)
write.table(Final_LL, file = "Final_LL_TC.xls", sep="\t", row.names = F)
...
############QQ#########
Final_RMSE_QQ=cbind(subset(Final_RMSE, select=c(RMSE_T,RMSE_R_A,(N_reg),(N_var))),1:287)
...
Final_LL_QQ=cbind(subset(Final_LL, select=c(LL_T,LL_R_Mean,(N_reg),(N_var))),1:287)
